<template>
  ...
  <van-grid class="goods-list" :column-num="columnNum" :gutter="gutter" :border="false">
    <van-grid-item v-for="goods in goodslist" :key="goods.id" :to="'/credit/detail/'+goods.id">
      <div class="goods-item" :style="'width:'+itemSize+'px'">
        <img fit="scale-down" :width="itemSize" :height="itemSize" v-lazy="`${img.url}`"  v-for="img in goods.images.slice(0, 1)" />
