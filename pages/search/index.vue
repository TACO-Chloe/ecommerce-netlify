...
export default {
  ...
  methods: {
    ...
    searchGoods() {
      ...
      // });
	  var data = {"total":1,"pages":1,"limit":10,"page":1,"list":[{"id":1181535,"name":"水泥","brief":"普通硅酸盐水泥，可提供发票","picUrl":"http://122.51.199.160:8080/wx/storage/fetch/owkk38ab8kp932a9k545.png","isNew":true,"isHot":true,"counterPrice":647.00,"retailPrice":679.00}],"filterCategoryList":[]}
	  this.list.push(...data.list);
      this.page = data.page;
      this.limit = data.limit;
      this.pages = data.pages;
